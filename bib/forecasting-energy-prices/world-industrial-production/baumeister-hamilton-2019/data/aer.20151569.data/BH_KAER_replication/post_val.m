function objective=post_val(theta_hat,param,Syy,Sxy,eta,M1,M2,M3,M_star1,M_star2,M_star3,S)
...
prior_e = student_prior(theta_hat(1,1),c_eta1,sigma_eta1,nu_eta1);
prior_b = student_prior(theta_hat(2,1),c_beta,sigma_beta,nu_beta);
prior_c = student_prior(theta_hat(3,1),c_gamma2,sigma_gamma2,nu_gamma2);
    
A=[1 0 0; -theta_hat(1,1) 1 0; -theta_hat(2:3,1)' 1];
